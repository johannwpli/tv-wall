...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        '00VpYJDR5XI': 'Audionix',
        'F1c0KYiJ8UE': 'DD Cyprus1Click',
        '-mwcpn8Lbco': 'e.hocamm web 1',
        'Y3ZY_ypepxE': 'e.hocamm web 2',
        'e9I3i37jcQA': 'Inquizex',
        '3r2eWXPYuHE': 'Ionatan Funny',
        'iZebYm-nenY': 'Livestream Events',
        '-3AG_jNfsuw': 'Lucas Mieli',
        'r-1T1LncPNU': 'NÔMADE BR',
        '3hiyVq44pK8': 'SameWaveLength',
        'VX9JZw3iD3E': 'SBK SHOW',
        'Yq-J0x3vF9Q': 'Sloth On Meth',
        'fH8NQwG52Xs': 'The Valkyrie',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        'gXSXi4ITJHg': 'War Stream',
        'sCCGp222WSA': 'Zabby',
      },
