...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        'cabGOh94ZY8': 'Audionix',
        'zGI0oI97690': 'DD Cyprus1Click',
        '1geefMwZjac': 'e.hocamm web 1',
        '1ufxVb_QVVk': 'e.hocamm web 2',
        'UOKxRFJLNNA': 'Inquizex',
        'iZebYm-nenY': 'Livestream Events',
        '2R6vOb1gRnE': 'Ionatan Funny',
        'TKrdiY27BKY': 'Lucas Mieli',
        '3hiyVq44pK8': 'SameWaveLength',
        'J37Ctv_BJR4': 'SBK SHOW',
        'HaUMvCEWFOE': 'Sloth On Meth',
        'omnthNWHNZU': 'The Valkyrie',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        '_Vo46hK2Cqs': 'War Stream',
        'UwKu1fq1kzQ': 'Zabby',
      },
