...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        'Fm0B7Iw6AT8': 'Audionix',
        'PVgM1p0vuQw': 'Chiosphotos.gr',
        'LBSjlcHOgLk': 'DD Cyprus1Click',
        'jINyuBAcxNM': 'e.hocamm web 1',
        'BBXQTH0ZIuw': 'e.hocamm web 2',
        'wjXIK1OhEn8': 'Inquizex',
        'iZebYm-nenY': 'Livestream Events',
        '1oXTjcXOnTc': 'Newton 1',
        'NoiNZRKp-3U': 'Newton 2',
        '0CSibB1Wh_s': 'Newton 3',
        'Hk1y7dsmH6E': 'Ionatan Funny',
        'yi6HpQLrZII': 'Lucas Mieli',
        //'0Zy-EJuWr8M': 'Politischios.gr',
        'YWg4al4R2s8': 'Pony Swedman TV 1',
        'm7cvmiR-tTQ': 'Pony Swedman TV 2',
        'hLxFOzr-tms': 'RICIERG',
        '_wosORrxwO4': 'SBK SHOW',
        'kqky55u4Ej4': 'Sloth On Meth',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        '-5R_dksK3C4': 'Zabby',
        'XeVaxG3QAqI': 'Webcam Live Stream 1',
        'uORr2RMh8kE': 'Webcam Live Stream 2',
        'IhmO2ZQJSPw': 'Webcam Live Stream 3',
        's2vBMwCjcMU': 'WorldCam',
      },
