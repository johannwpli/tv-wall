...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        'KT5dKjDihP8': 'Audionix',
        'PVgM1p0vuQw': 'Chiosphotos.gr',
        '5Wxt-rjlY7Y': 'DD Cyprus1Click',
        'PYWnE8AMADQ': 'e.hocamm web 1',
        'ZaE2INoAgJ0': 'e.hocamm web 2',
        'wZwlrtCqCwI': 'Inquizex',
        'iZebYm-nenY': 'Livestream Events',
        'rqfvsBmJsaw': 'Lucas Mieli',
        '0Zy-EJuWr8M': 'Politischios.gr',
        'aBh-q-nIUUE': 'Pony Swedman TV',
        'Xujh0cAVWaE': 'RICIERG',
        'exfJ09EofpM': 'SBK SHOW',
        'GfKCoWRFn0U': 'Sloth On Meth',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        '_KW-Tvc000A': 'Zabby',
        '56MPd4JrUCk': 'Webcam Live Stream',
        'ox4dwda6AOs': 'Webcam Live Stream',
        'Z5RuOJNsk_U': 'Webcam Live Stream',
        'IrIwFMxIKQw': 'WorldCam',
      },
