...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        ...
        'Uohrj7t6Fyc': 'e.hocamm web',
        'xWVKynb4cpU': 'e.hocamm web',
        'wZwlrtCqCwI': 'Inquizex',
        'iZebYm-nenY': 'Livestream Events',
        'y8Tzqymldck': 'Lucas Mieli',
        '0Zy-EJuWr8M': 'Politischios.gr',
        'CPrEmEI1SCc': 'Pony Swedman TV',
        'XPAILl5bYUs': 'RICIERG',
        'Syctgzhsgkc': 'SBK SHOW',
        'jbe4BOj-NsA': 'Sloth On Meth',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        '7NttyW58Wj4': 'Zabby',
        'IyUk0I5WrT0': 'Webcam Live Stream',
        'ZTKDnwB4d-Y': 'Webcam Live Stream',
        'GpmbZHHQr6U': 'Webcam Live Stream',
        'vDSDGyJQyhc': 'WorldCam',
      },
