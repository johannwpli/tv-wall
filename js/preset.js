...
let /* set tv */
    ...
    tvSrcObj = {
      ...
      Ukraine: {
        '6G3KhoT753E': 'Audionix',
        'PVgM1p0vuQw': 'Chiosphotos.gr',
        'YzeJVIp7FcQ': 'DD Cyprus1Click',
        'DP1TMKf5J_A': 'e.hocamm web 1',
        'w6GqDHUIC1A': 'e.hocamm web 2',
        'lSMzyzXOIK0': 'Inquizex',
        'iZebYm-nenY': 'Livestream Events',
        'bvD81I2H2mI': 'Newton 1',
        'ENw_ZroFUcM': 'Newton 2',
        'jXwLoUyTk5g': 'Newton 3',
        'nfZC1OfKUd4': 'Ionatan Funny',
        'rqfvsBmJsaw': 'Lucas Mieli',
        '0Zy-EJuWr8M': 'Politischios.gr',
        '77xmd6dvtZw': 'Pony Swedman TV',
        'qWL3OtPVhEI': 'RICIERG',
        '8032GC_l-Q4': 'SBK SHOW',
        'bo4Vo9OQzWY': 'Sloth On Meth',
        'e2gC37ILQmk': 'TVL Trzcianka',
        'uT6RDbXEBj4': 'VBMedia',
        '5GKCWW4_5mY': 'Zabby',
        '4kD_RKBlrM4': 'Webcam Live Stream 1',
        'ePYMNjrOByw': 'Webcam Live Stream 2',
        '4xowKLQmF0Q': 'Webcam Live Stream 3',
        'XphaDjVZQcg': 'WorldCam 1',
        'caIHbR87YYw': 'WorldCam 2',
      },
